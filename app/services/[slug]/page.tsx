...
const SERVICES: Record<string, {
  ...
  'fractional-cmo': {
    ...
    description: [
      ...
      'We have launched brands including WhichPodcast and Ayla Property from zero, building positioning, go to market strategy and early acquisition from scratch. We have also scaled established names including Barry\'s Bootcamp, Rhythm Nutrition and Chesneys, stepping in as the senior marketing voice across paid and organic. The brands that work with us do not need more hands. They need someone to lead.',
      'We work across the full marketing mix. Online this means Meta, Google Ads and SEO. Offline it means press, TV and billboards. We can come in purely as a strategic partner, attending leadership meetings and setting direction, or we can assume full control of execution across every channel. Most clients land somewhere in between. We adapt to whatever level of involvement makes sense for the business.',
    ],
    outcomes: [
