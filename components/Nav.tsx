    ...
    <>
      <nav className={`${styles.nav} ${scrolled ? styles.scrolled : ''}`}>
        ...
        <ul className={styles.links}>
          ...
          <li><Link href="/ai-software-tutorials" className={styles.course}>AI Cheat Sheet Tutorials</Link></li>
      ...
      <div className={`${styles.mobileMenu} ${open ? styles.mobileMenuOpen : ''}`}>
        <ul className={styles.mobileLinks}>
          ...
          <li><Link href="/ai-software-tutorials" className={styles.mobileCourse} onClick={close}>AI Cheat Sheet Tutorials</Link></li>
